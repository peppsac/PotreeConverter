...
Arguments parseArguments(int argc, char **argv){
	...
	desc.add_options()
		...
		("output-format", po::value<string>(&a.outFormatString), "Output format can be BINARY, CIN, LAS or LAZ. Default is BINARY")
	...
	}else if(a.outFormatString == "CIN"){
		a.outFormat = Potree::OutputFormat::CUSTOM_BINARY;
	}
